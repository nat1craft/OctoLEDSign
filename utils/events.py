...
class _EventSlot:
    ...
    def __getitem__(self, key):
        if key is None or key not in self.targets:
            return None
...
class Events:
    ...
    """
    def __init__(self, events=None, event_slot_cls=None):
        self.__event_slot_cls__ = event_slot_cls if event_slot_cls is not None else _EventSlot
